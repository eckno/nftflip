class emailTemplates
{
    ...
    static welcome_mail(senderName, token)
    {
        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
          <head>
            <title>WELCOME TO NFTFLIP</title>
                    ...
                    <tr>
                      <td valign="top" class="em_aside">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:15px; font-weight:bold; line-height:18px; color:#30373b;">Welcome ${senderName}</td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td valign="top" align="center">
                              <table width="210" border="0" cellspacing="0" cellpadding="0" align="center">
                                <tr>
                                <a href="http://localhost:5000/create_verification?token=${token}">
                                  <td valign="middle" align="center" height="45" bgcolor="#feae39" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; font-weight:bold; color:#ffffff; text-transform:uppercase;">Verify Account</td>
                                </a>
                                </tr>
                              </table>
                            </td>
